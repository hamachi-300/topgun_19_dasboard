...
# === 1. CONFIGURATION ===
CAM_ID = "a80a1e35-16c4-4629-a985-9b94ecb0bb75"
url = f"https://tesa-api.crma.dev/api/object-detection/{CAM_ID}"
token = "13860b4df6caf9d41fd2c83725e262d61ce3fdc7f8fe1d588f105e18b1f5e13d"
...
# === 2. LOAD CSV DATA ===
csv_data_list = []
csv_path = "data_from_drone/submission.csv"
...
# === 3. LOAD IMAGES ===
folder_path = "data_from_drone/images"
...
try:
    while True:
        ...
        # --- create detection object (with nested details) ---
        detected_objects = [{
        ...
        try:
            with open(image_file_path, "rb") as f:
                files_payload = {"image": (os.path.basename(image_file_path), f, "image/jpeg")}
